<div class="col-md-2 sidebar" style="margin-left:20px">
	...
	<div class="side-menu">
		<nav class="navbar navbar-default" role="navigation">
			...
			<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='customers.php'"><span class="glyphicon glyphicon-edit pull-left"></span> Customers </button></li>
