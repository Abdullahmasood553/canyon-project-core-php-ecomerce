<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
	<div class="carousel-inner">
		<div class="item active">
			<?php 
				$recommended=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%bottle%' order by rand() LIMIT 0,4")or die("Query 1 is inncorrect..........");
 	...
 	<div class="item"><?php 
			$recommended=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%nailart%' order by rand()  LIMIT 0,4")or die("Query 1 is inncorrect..........");
			while(list($product_id,$product_name,$image,$price,$c_price)=mysqli_fetch_array($recommended))
			{
			echo"
			<div class='col-sm-4'>
